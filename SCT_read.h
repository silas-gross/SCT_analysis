...
class SCT_read {
public: 
	void SCT_read::scan_dat_file(fstream* inf, TFile* f, int boardnumber, std::string time_code, bool aon, bool lastof, int rn);
	void SCT_read::scan_irrad_file(std::fstream* inf, TFile* f, int boardnumber);
private:
